    ...
    <div name='contact' className='w-full h-screen bg-[#0a192f] flex justify-center items-center p-4'>
        <form action="" className='flex flex-col max-w-[600px] w-full'>
            <div className='pb-8'>
                ...
                <p className='text-gray-300 py_4'>email - zoufan9@gmail.com</p>
            </div>
            ...
            <button className='text-white border-2 hover:bg-[#C8A2C8] hover:border-[#C8A2C8] px-4 py-3 my-8 mx-auto rounded-md'>Let's Collaborate</button>
        </form>
    </div>
  )
}
